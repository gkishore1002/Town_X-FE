    ...
    (action) => {
      switch (action) {
        ...
        case "post":
          ...
          break;
        case "signup":
          openAuthDrawer("signup", { from: "/home" });
          break;
        case "signup-owner":
          openAuthDrawer("signup", { from: "/home", defaultRole: "owner" });
          break;
        default:
          break;
      }
    },
    [navigate, shouldReduceMotion, handleCreatePost, openAuthDrawer]
  );
    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-3">
            ...
            >
              ...
              <div className="min-w-0 flex flex-col">
                <span className="font-display text-sm sm:text-base font-semibold text-gray-900 leading-tight tracking-wide truncate">
                  {APP_NAME}
                </span>
            ...
            <div className="flex flex-wrap items-center justify-end gap-1.5 sm:gap-2 flex-shrink-0">
              ...
              <button
                ...
                className="px-2.5 py-2 sm:px-4 sm:py-2.5 rounded-control font-medium text-sm flex items-center gap-1.5 text-white bg-brand-500 hover:bg-brand-700 shadow-soft-sm hover:shadow-brand-glow transition-all"
              >
                <Plus className="w-4 h-4" />
                <span className="hidden sm:inline">{config.header.postButton.text || "Post Property FREE"}</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <section className="bg-brand-900 text-white">
        <div className="max-w-6xl mx-auto px-4 py-3 flex flex-col sm:flex-row items-center justify-center gap-3 text-center">
          ...
          <button
            ...
            className="px-3 sm:px-4 py-1.5 rounded-control text-xs font-semibold bg-white text-brand-800 hover:bg-brand-50 transition-colors shrink-0"
          >
            Explore Listings
          </button>
        </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="px-4 py-6 border-b border-gray-100">
          <div className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-5 gap-2 sm:gap-3 text-center">
            {[
          ...
          <section id="stories-section" className="px-4 py-5">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 snap-x scrollbar-hide">
              <button
                ...
                className="flex-shrink-0 snap-start w-20 h-28 sm:w-24 sm:h-32 rounded-card bg-gray-50 border-2 border-dashed border-brand-200 hover:border-brand-600 flex flex-col items-center justify-center gap-2 transition-all shadow-soft-sm hover:shadow-soft-md"
              >
              ...
              {stories.map((story) => (
                <button
                  ...
                  className="flex-shrink-0 snap-start w-20 h-28 sm:w-24 sm:h-32 rounded-card overflow-hidden relative group border border-brand-100 shadow-soft-sm hover:shadow-soft-md transition-shadow"
                >
        ...
        <section className="px-4 py-6">
          <div className="rounded-card bg-gray-50 border border-gray-100 p-6 md:p-8 flex flex-col md:flex-row items-center gap-6">
            ...
            <button
              onClick={() => openAuthDrawer("signup", { from: "/home", defaultRole: "owner" })}
        ...
        {/* ==================== HOW IT WORKS ==================== */}
        <section className="bg-brand-900 px-4 py-10 md:rounded-card">
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2.5">
              <TownExchangeLogo size={32} className="rounded-full bg-white border border-gray-200" />
